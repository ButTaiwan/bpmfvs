...
#make_font('jf-openhuninn-1.1.ttf', 'ㄅ注音粉圓', 'Bpmf huninn', '1.000', true, 29)
#make_font('SourceHanSansTW-Regular.ttf', 'ㄅ字嗨注音黑體', 'Bpmf Zihi Sans', '1.000')

make_font('ZihiKaiStd.ttf', 'ㄅ字嗨注音標楷', 'Bpmf Zihi KaiStd', '1.000', true)
make_font('GenRyuMinTW-B.ttf', 'ㄅ源流注音明體', 'Bpmf GenRyu Min', '1.000', true)
make_font('GenRyuMinTW-EL.ttf', 'ㄅ源流注音明體', 'Bpmf GenRyu Min', '1.000', true)
make_font('GenRyuMinTW-H.ttf', 'ㄅ源流注音明體', 'Bpmf GenRyu Min', '1.000', true)
make_font('GenRyuMinTW-L.ttf', 'ㄅ源流注音明體', 'Bpmf GenRyu Min', '1.000', true)
make_font('GenRyuMinTW-M.ttf', 'ㄅ源流注音明體', 'Bpmf GenRyu Min', '1.000', true)
make_font('GenRyuMinTW-R.ttf', 'ㄅ源流注音明體', 'Bpmf GenRyu Min', '1.000', true)
make_font('GenRyuMinTW-SB.ttf', 'ㄅ源流注音明體', 'Bpmf GenRyu Min', '1.000', true)
make_font('GenSekiGothicTW-B.ttf', 'ㄅ源石注音黑體', 'Bpmf GenSeki Gothic', '1.000', true)
make_font('GenSekiGothicTW-H.ttf', 'ㄅ源石注音黑體', 'Bpmf GenSeki Gothic', '1.000', true)
make_font('GenSekiGothicTW-L.ttf', 'ㄅ源石注音黑體', 'Bpmf GenSeki Gothic', '1.000', true)
make_font('GenSekiGothicTW-M.ttf', 'ㄅ源石注音黑體', 'Bpmf GenSeki Gothic', '1.000', true)
make_font('GenSekiGothicTW-R.ttf', 'ㄅ源石注音黑體', 'Bpmf GenSeki Gothic', '1.000', true)
make_font('GenSenRoundedTW-B.ttf', 'ㄅ源泉注音圓體', 'Bpmf GenSen Rounded', '1.000', true)
make_font('GenSenRoundedTW-EL.ttf', 'ㄅ源泉注音圓體', 'Bpmf GenSen Rounded', '1.000', true)
make_font('GenSenRoundedTW-H.ttf', 'ㄅ源泉注音圓體', 'Bpmf GenSen Rounded', '1.000', true)
make_font('GenSenRoundedTW-L.ttf', 'ㄅ源泉注音圓體', 'Bpmf GenSen Rounded', '1.000', true)
make_font('GenSenRoundedTW-M.ttf', 'ㄅ源泉注音圓體', 'Bpmf GenSen Rounded', '1.000', true)
make_font('GenSenRoundedTW-R.ttf', 'ㄅ源泉注音圓體', 'Bpmf GenSen Rounded', '1.000', true)
make_font('GenWanMinTW-EL.ttf', 'ㄅ源雲注音明體', 'Bpmf GenWan Min', '1.000', true)
make_font('GenWanMinTW-L.ttf', 'ㄅ源雲注音明體', 'Bpmf GenWan Min', '1.000', true)
make_font('GenWanMinTW-M.ttf', 'ㄅ源雲注音明體', 'Bpmf GenWan Min', '1.000', true)
make_font('GenWanMinTW-R.ttf', 'ㄅ源雲注音明體', 'Bpmf GenWan Min', '1.000', true)
make_font('GenWanMinTW-SB.ttf', 'ㄅ源雲注音明體', 'Bpmf GenWan Min', '1.000', true)
make_font('GenYoGothicTW-B.ttf', 'ㄅ源樣注音黑體', 'Bpmf GenYo Gothic', '1.000', true)
make_font('GenYoGothicTW-EL.ttf', 'ㄅ源樣注音黑體', 'Bpmf GenYo Gothic', '1.000', true)
make_font('GenYoGothicTW-H.ttf', 'ㄅ源樣注音黑體', 'Bpmf GenYo Gothic', '1.000', true)
make_font('GenYoGothicTW-L.ttf', 'ㄅ源樣注音黑體', 'Bpmf GenYo Gothic', '1.000', true)
make_font('GenYoGothicTW-M.ttf', 'ㄅ源樣注音黑體', 'Bpmf GenYo Gothic', '1.000', true)
make_font('GenYoGothicTW-N.ttf', 'ㄅ源樣注音黑體', 'Bpmf GenYo Gothic', '1.000', true)
make_font('GenYoGothicTW-R.ttf', 'ㄅ源樣注音黑體', 'Bpmf GenYo Gothic', '1.000', true)
make_font('GenYoMinTW-B.ttf', 'ㄅ源樣注音明體', 'Bpmf GenYo Min', '1.000', true)
make_font('GenYoMinTW-EL.ttf', 'ㄅ源樣注音明體', 'Bpmf GenYo Min', '1.000', true)
make_font('GenYoMinTW-H.ttf', 'ㄅ源樣注音明體', 'Bpmf GenYo Min', '1.000', true)
make_font('GenYoMinTW-L.ttf', 'ㄅ源樣注音明體', 'Bpmf GenYo Min', '1.000', true)
make_font('GenYoMinTW-M.ttf', 'ㄅ源樣注音明體', 'Bpmf GenYo Min', '1.000', true)
make_font('GenYoMinTW-R.ttf', 'ㄅ源樣注音明體', 'Bpmf GenYo Min', '1.000', true)
make_font('GenYoMinTW-SB.ttf', 'ㄅ源樣注音明體', 'Bpmf GenYo Min', '1.000', true)
make_font('SourceHanSansTW-Bold.ttf', 'ㄅ字嗨注音黑體', 'Bpmf Zihi Sans', '1.000', true)
make_font('SourceHanSansTW-ExtraLight.ttf', 'ㄅ字嗨注音黑體', 'Bpmf Zihi Sans', '1.000', true)
make_font('SourceHanSansTW-Heavy.ttf', 'ㄅ字嗨注音黑體', 'Bpmf Zihi Sans', '1.000', true)
make_font('SourceHanSansTW-Light.ttf', 'ㄅ字嗨注音黑體', 'Bpmf Zihi Sans', '1.000', true)
make_font('SourceHanSansTW-Medium.ttf', 'ㄅ字嗨注音黑體', 'Bpmf Zihi Sans', '1.000', true)
make_font('SourceHanSansTW-Regular.ttf', 'ㄅ字嗨注音黑體', 'Bpmf Zihi Sans', '1.000', true)
make_font('SourceHanSerifTW-Bold.ttf', 'ㄅ字嗨注音宋體', 'Bpmf Zihi Serif', '1.000')
make_font('SourceHanSerifTW-ExtraLight.ttf', 'ㄅ字嗨注音宋體', 'Bpmf Zihi Serif', '1.000')
make_font('SourceHanSerifTW-Heavy.ttf', 'ㄅ字嗨注音宋體', 'Bpmf Zihi Serif', '1.000')
make_font('SourceHanSerifTW-Light.ttf', 'ㄅ字嗨注音宋體', 'Bpmf Zihi Serif', '1.000')
make_font('SourceHanSerifTW-Medium.ttf', 'ㄅ字嗨注音宋體', 'Bpmf Zihi Serif', '1.000')
make_font('SourceHanSerifTW-Regular.ttf', 'ㄅ字嗨注音宋體', 'Bpmf Zihi Serif', '1.000')
make_font('SourceHanSerifTW-SemiBold.ttf', 'ㄅ字嗨注音宋體', 'Bpmf Zihi Serif', '1.000')
